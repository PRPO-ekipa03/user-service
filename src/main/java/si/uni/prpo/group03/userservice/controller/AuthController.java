...
public class AuthController {
    ...
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Token is valid, returns user ID", content = @Content(schema = @Schema(type = "string"))),
    ...
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Account confirmed successfully", content = @Content(schema = @Schema(type = "string"))),
    ...
    @ApiResponses({
        @ApiResponse(responseCode = "202", description = "Password reset email sent", content = @Content(schema = @Schema(type = "string"))),
    ...
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Password reset successfully", content = @Content(schema = @Schema(type = "string"))),
        @ApiResponse(responseCode = "400", description = "Invalid reset data", content = @Content)
    })
